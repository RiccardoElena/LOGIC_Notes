...
\begin{itemize}
  ...
  \[\exists g\st (G(g) \land \forall v((V(v,g) \land c(v)=N) \rightarrow \exists u_1\st \exists u_2\st (V(u_1,g) \land V(u_2,g) \land E(u_1,v,g) \land E(u_2,v,g) \land c(u_1)=B \land c(u_2)=B \land \neg E(u_1,u_2,g) \land \neg(u_1=u_2))))\]

  \item \textbf{(e)} In un arbitrario grafo, almeno un vertice di colore bianco ha meno di 3 vertici neri tra i suoi adiacenti.
  \[\forall g(G(g) \rightarrow \exists v\st (V(v,g) \land c(v)=B \land \forall u_1 \forall u_2 \forall u_3 ((V(u_1,g) \land V(u_2,g) \land V(u_3,g) \land E(v,u_1,g) \land E(v,u_2,g) \land E(v,u_3,g) \land c(u_1)=N \land c(u_2)=N \land c(u_3)=N) \rightarrow (u_1=u_2 \lor u_2=u_3 \lor u_1=u_3))))\]
\end{itemize}
