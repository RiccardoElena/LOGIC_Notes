...
\begin{itemize}
  ...
  \[
  \begin{aligned}
    \forall d &(Sc(d) \rightarrow \exists p\st (P(p) \wedge St(p,d) \wedge \\
    &\exists e_1, e_2, e_3\st (E(e_1) \wedge E(e_2) \wedge E(e_3) \wedge M(e_1) \wedge M(e_2) \wedge M(e_3) \wedge S(p,e_1) \wedge S(p,e_2) \wedge S(p,e_3) \wedge \\
    &\neg(e_1=e_2) \wedge \neg(e_2=e_3) \wedge \neg(e_3=e_1))))
  \end{aligned}
  \]
  ...
  \[
  \begin{aligned}
    \forall p_1 &\forall p_2 ((P(p_1) \wedge P(p_2) \wedge \exists d\st (Sc(d) \wedge St(p_1,d)) \wedge \exists d\st (Sc(d) \wedge St(p_2,d))) \rightarrow \\
    &\forall e\st ((E(e) \wedge M(e)) \rightarrow (S(p_1,e) \leftrightarrow S(p_2,e))))
  \end{aligned}
  \]
  ...
  \[
  \begin{aligned}
    \forall p &((P(p) \wedge \exists d\st (Sc(d) \wedge St(p,d))) \rightarrow \\
    &\forall e_1 \forall e_2 \forall e_3 ((E(e_1) \wedge E(e_2) \wedge E(e_3) \wedge M(e_1) \wedge M(e_2) \wedge M(e_3) \wedge S(p,e_1) \wedge S(p,e_2) \wedge S(p,e_3)) \rightarrow\\
    & (e_1=e_2 \vee e_2=e_3 \vee e_1=e_3)))
  \end{aligned}
  \]
\end{itemize}
