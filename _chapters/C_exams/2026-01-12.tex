...
\begin{itemize}
    ...
    \[\exists x \st (N(x) \land P(x) \land \forall i \forall j \forall k \forall l ((N(i) \land N(j) \land N(k) \land N(l) \land Div(x,i) \land Div(x,j) \land Div(x,k) \land Div(x,l)) \to (i=j \lor i=k \lor i=l \lor j=k \lor j=l \lor k=l)))\]
