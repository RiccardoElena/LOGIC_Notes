\section{Tema d'esame del 20 Giugno 2024}
...
\subsubsection*{(a) \((P\vee Q)\rightarrow(P\rightarrow Q)\)}
...
\subsubsection*{(c) \(((P\wedge Q)\wedge(Q\rightarrow\neg P))\)}
...
\(J(\cdot)=\) \q{è giornale}; \(G(\cdot)=\) \q{è giornalista}; \(F(\cdot,\cdot)=\) \q{è figlio di}; \(L(\cdot,\cdot)=\) \q{legge}; \(C(\cdot,\cdot)=\) \q{compra}; \(S(\cdot,\cdot)=\) \q{scrive per}.
...
\begin{itemize}
    ...
    \begin{align*}
    \exists g\st (& G(g)\wedge\forall f(F(f,g)\rightarrow\forall j_1\forall j_2\forall j_3((\\
                  & J(j_1)\wedge J(j_2)\wedge J(j_3)\wedge L(f,j_1)\wedge L(f,j_2)\wedge L(f,j_3)\wedge \\
...
\subsubsection*{(a) \(\forall x.(P(x)\rightarrow Q(x))\rightarrow(\exists x.P(x)\rightarrow\exists y.Q(y))\)}
...
\subsubsection*{(b) \(\exists x.P(x)\wedge\forall x.\neg P(x)\)}
...
\subsubsection*{(d) \(\exists x.(P(x)\rightarrow Q(x))\rightarrow(\exists x.P(x)\rightarrow\exists x.Q(x))\)}
...
\subsubsection*{(e) \((\exists y.P(c,y)\wedge(c=d))\rightarrow\exists y.P(d,y)\)}
