\section{Tema d'esame del 11 Settembre 2024}
...
\subsubsection*{(a) \((A\rightarrow B)\rightarrow((\neg B\rightarrow A)\rightarrow B)\) }
...
\subsubsection*{(e) \(((A\wedge B)\vee(A\vee C))\rightarrow(\neg A\rightarrow C)\)}
...
\begin{itemize}
  \item \textbf{(a)} Nessuna persona vive su Marte o Venere.
    \[ \neg\exists p \st (P(p)\wedge (In(p,\text{Marte})\vee In(p,\text{Venere}))) \]

  \item \textbf{(b)} Tutte le persone sono vicine a qualche persona ma nessuna persona è vicina a tutte le persone.
    \[ \forall p (P(p)\rightarrow \exists q \st (P(q)\wedge V(p,q))) \wedge \neg\exists p \st (P(p)\wedge \forall q (P(q)\rightarrow V(p,q))) \]

  \item \textbf{(c)} La persona più alta del mondo vive in Marocco.
    \[ \exists x \st (P(x)\wedge \forall p ((P(p)\wedge \neg(p=x))\rightarrow p<x) \wedge In(x,\text{Marocco})) \]

  \item \textbf{(d)} Ci sono solo tre persone più alte di Filippo.
    \begin{align*} 
    ...
    \item \textbf{(e)} La fila è un ordine discreto di persone. (Suddiviso in sotto-formule per chiarezza)
    \begin{align*}
...
\subsubsection*{(a) \(\forall x P(x)\wedge\neg\neg\exists x \st \neg P(x)\)}
...
\subsubsection*{(b) \(((\forall y R(a,y))\rightarrow P(a))\rightarrow((\exists y \st R(a,y))\rightarrow P(a))\)}
...
\subsubsection*{(e) \((a=b)\rightarrow((c=b)\rightarrow((\exists x \st R(a,x))\rightarrow(\exists x \st R(c,x))))\)}
