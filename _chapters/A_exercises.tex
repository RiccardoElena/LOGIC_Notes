...
Ancora una volta, la presenza di una disgiunzione tra le assunzioni ci porta ad usare \(\lor E\) per ottenere assunzioni scaricabili che ci permettono di dimostrare \(A \lor C\) e \(B \lor C\). Iniziamo con \(A \lor C\).
...
\begin{note}{}
  Mai come questo esercizio mosta come la regola di \(\lor E\) sia sottile. Infatti, nonostante ci dicesse già nella prima applicazione che avremmo potuto scaricare \(C\), questo era possibile solo in uno dei due rami, e non in entrambi. Per poterla scaricare anche nell'altro siamo stati costretti ad una seconda applicazione di \(\lor E\),
\end{note}
