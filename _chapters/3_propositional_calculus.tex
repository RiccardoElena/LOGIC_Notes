...
Vedremo in questo capitolo due calcoli, un primo detto \keyword{calcolo di deduzione naturale}, più affine al ragionamento umano, ed un secondo, detto \keyword{calcolo di risoluzione}, più affine ad un'implementazione automatica, e che è alla base di molti sistemi di dimostrazione automatica.
...
\begin{proof}
  ...
  Per mostrare che se \(\Sigma\) è consistente allora \(\Sigma\) è soddisfacibile, dobbiamo andare a costruire un modello \(m^*\) che soddisfa \(\Sigma\) sapendo che le formule di \(\Sigma\) sono consistenti.
...
\begin{definition}{Forma clausale}
  ...
  In altre parole, una formula è in forma clausale se è un insieme di insiemi di letterali.\footnote{Abbiamo dato la definizione di \Namedcref{def:literal} quando abbiamo introdotto le forme normali, nel secondo capitolo.}
\end{definition}
