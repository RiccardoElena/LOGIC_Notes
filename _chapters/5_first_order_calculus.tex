...
\begin{proof}
  ...
  dal momento che \(y\notin \Var(\phi)\) e \(x \in FV(\phi)\) e quindi che \(y\) è libero per \(x\) in \(\phi\).
...
Dobbiamo quindi estendere il linguaggio dimodoché ciascun \q{testimone} abbia una costante. Inoltre, aggiungeremo alla teoria degli assiomi, ovvero gli assiomi di Henkin, che leghino ciascuna formula esistenziale alla costante introdotta per il \q{testimone} di cui la formula parla.
